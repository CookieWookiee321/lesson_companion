...
//======================================================================
class CopyTextInputModeView extends StatefulWidget {
  const CopyTextInputModeView({Key? key}) : super(key: key);

  @override
  State<CopyTextInputModeView> createState() => _CopyTextInputModeViewState();
}

class _CopyTextInputModeViewState extends State<CopyTextInputModeView> {
